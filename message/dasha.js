...
{ urlButton: { displayText: `Github Bot`, url : `https://github.com/RidwanXyZ`} },
...
"url": "https://github.com/RidwanXyZ"
}
},
{
"callButton": {
"displayText": "𝑪𝒂𝒍𝒍 𝑶𝒘𝒏𝒆𝒓",
"phoneNumber": "6289514791129"
}
},
{
"quickReplyButton": {
...
let vcard = 'BEGIN:VCARD\n'
    ...
    + 'FN: Ridwan Sensei.\n'
    + 'ORG:Owner Bot;\n'
    + 'item1.TEL;type=CELL;type=VOICE;waid=6289514791129:+62 895-1479-1129\n' 
    + 'item1.X-ABLabel:Creator Dasha\n'
    + 'item2.EMAIL;type=INTERNET:ridwanzaynn@gmail.com\n'
    + 'item2.X-ABLabel:Email\n'
    + 'item3.URL:https://instagram.com/ridwanzayyn_\n'
    + 'item3.X-ABLabel:Instagram\n'
    + 'item4.ADR:;;Indonesia;;;;\n'
    + 'item4.X-ABLabel:Region\n'
    + 'END:VCARD'
dasha.sendMessage(from, { contacts: { displayName: 'リドワン　先制', contacts: [{ vcard }] } }, { quoted: msg })
break
...
if (!quoted)return textImg(`Reply Media dengan caption ${prefix + command} Punya|Akutagawa`)
